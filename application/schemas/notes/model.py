...
class Notes(CrudMixin):
    ...
    user_uu_id: Mapped[str] = mapped_column(UUID, ForeignKey("users.uu_id"), nullable=False)
...
class Comments(CrudMixin):
    ...
    content: Mapped[str] = mapped_column(Text, nullable=False)
    note_uu_id: Mapped[str] = mapped_column(UUID, ForeignKey("notes.uu_id"), nullable=False)
    user_uu_id: Mapped[str] = mapped_column(UUID, ForeignKey("users.uu_id"), nullable=False)
